...
@ApiModel(value="share_list对象", description="分享表")
public class ShareList implements Serializable {
	...
	/**分享课程id*/
	@Excel(name = "分享课程id", width = 15)
    @ApiModelProperty(value = "分享课程id")
    private java.lang.String shareCourseId;
	/**查阅人id*/
	@Excel(name = "查阅人id", width = 15)
    @ApiModelProperty(value = "查阅人id")
    private java.lang.String personToSee;
}
